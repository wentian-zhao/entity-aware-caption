DATASET="goodnews"
RUN_NAME="checkpoint_transformer_conv_wide_16head_$DATASET"

python train.py --user-dir . --save-dir "../save/$RUN_NAME" --tensorboard-logdir "../save/$RUN_NAME/log" \
    --task caption --dataset $DATASET --valid-subset test-small --arch transformer2_conv_mm --use-image 0 \
    ...
    --batch-size 16 --t-total 437600 --num-workers 1 --max-update 437600 --validate-interval 2 \
